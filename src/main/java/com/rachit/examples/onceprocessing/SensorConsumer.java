package com.rachit.examples.onceprocessing;
...
public class SensorConsumer{
    ...
    private static long getOffsetFromDB(TopicPartition p){
        ...
        try{
            ...
            String sql = "select offset from tss_offsets where topic_name='" + p.topic() + "' and partitiont=" + p.partition();
    ...
    private static void saveAndCommit(KafkaConsumer<String, String> c, ConsumerRecord<String, String> r){
        ...
        try{
            ...
            String updateSQL = "update tss_offsets set offset=? where topic_name=? and partitiont=?";
